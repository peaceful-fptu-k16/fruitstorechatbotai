...
os.environ.setdefault("RESPONSE_GENERATION_MODE", "deterministic")
os.environ.setdefault("ENABLE_LLM_RESPONSE_REWRITE", "false")
os.environ.setdefault("GEMINI_API_KEY", "")
os.environ.setdefault("ENABLE_USER_QUERY_LOGGING", "false")
os.environ.setdefault("ENABLE_QA_PAIR_LOGGING", "false")
os.environ.setdefault("ENABLE_ANSWER_QUALITY_REVIEW", "false")
